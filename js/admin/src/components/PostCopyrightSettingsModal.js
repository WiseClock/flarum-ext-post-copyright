        ...
        return [
            m('div', {className: 'WiseClockPostCopyright'}, [
                m('fieldset', {className: 'WiseClockPostCopyright-default-ui'}, [
                    m('legend', {}, app.translator.trans('jc-proplus-post-copyright.admin.settings.ui.title')),
                    Switch.component(
                    {
                        ...
                        children: app.translator.trans('jc-proplus-post-copyright.admin.settings.ui.primary_color'),
                    }),
                    Switch.component(
                    {
                        state: JSON.parse(this.setting('jc-proplus.post-copyright.discussions_only', 0)()),
                        onchange: this.setting('jc-proplus.post-copyright.discussions_only'),
                        children: app.translator.trans('jc-proplus-post-copyright.admin.settings.ui.discussions_only'),
                    }),
                    Switch.component(
                    {
                        state: JSON.parse(this.setting('jc-proplus.post-copyright.align_right', 0)()),
                    ...
                    m('label', {}, app.translator.trans('jc-proplus-post-copyright.admin.settings.ui.copyright')),
                    m('input', {className: 'FormControl', bidi: this.setting('jc-proplus.post-copyright.icon', '© ')}),
                ]),
                m('fieldset', {className: 'WiseClockPostCopyright-default-edit'}, [
                    m('legend', {}, app.translator.trans('jc-proplus-post-copyright.admin.settings.edit.title')),
                    Switch.component(
                    {
                        ...
                        children: app.translator.trans('jc-proplus-post-copyright.admin.settings.edit.allow_trespass'),
                    }),
                ]),
                m('fieldset', {className: 'WiseClockPostCopyright-default-switch'}, [
                    m('legend', {}, app.translator.trans('jc-proplus-post-copyright.admin.settings.defaults.title')),
                    m('div', {className: 'helpText'}, app.translator.trans('jc-proplus-post-copyright.admin.settings.defaults.help')),
                    Switch.component(
                    {
                ...
                m('fieldset', {className: 'WiseClockPostCopyright-addition'}, [
                    m('legend', {}, app.translator.trans('jc-proplus-post-copyright.admin.settings.addition.title')),
                    m('div', {className: 'helpText'}, app.translator.trans('jc-proplus-post-copyright.admin.settings.addition.help')),
                    ...
                    m('div', {className: 'helpText'}, app.translator.trans('jc-proplus-post-copyright.admin.settings.addition.notes')),
                    m('textarea',
                    {
